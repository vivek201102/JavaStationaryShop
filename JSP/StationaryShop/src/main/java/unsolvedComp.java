...
public class unsolvedComp extends HttpServlet{
	...
	public void service(HttpServletRequest request,HttpServletResponse response) throws IOException {
		...
		while(rs.next()){
			...
			out.print(s1);
			rs2 = stm2.executeQuery("select * from user where mobile='"+rs.getString("mobile")+"'");
			if(rs2.next())
		...
		s2 = "<tr><th>Name</th><td>"+name+"</td><td></tr>"+
				...
				"<tr><th>Category</th><td>"+rs.getString("issue")+"</td><td></tr>"+
				"<tr><th>Complaint</th><td>"+rs.getString("detail")+"</td><td></tr>"+
		...
		String home = "<button class='btn btn-primary'>Commit changes</button></form>"
				+ "<div class='container'><h4><button class='btn btn-primary' onclick=\"history.back()\" >Go Back</button></h4></div>";
		out.print(home);
	}
		catch(Exception e) {
