...
class Customer implements Serializable{
    ...
    Customer(){}
    public Customer(String cName, String email, long mobile, String dob, String houseNo, String address1, String address2, String city, long pincode, String lastLogin) {
        this.cName = cName;
        this.email = email;
        this.dob = dob;
        this.mobile = mobile;
    ...
    void display(ArrayList<Order> order, OrderHistory history)
    {
        ...
        System.out.println("Name: "+ cName + "\nEmail: " + email + "\nOrdering Time: "+ history.getDateTime()+ "\nMobile No: " + mobile + "\n");
